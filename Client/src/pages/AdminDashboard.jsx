    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {currentView === "dashboard" ? (
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  ...
                  <button
                    key={label}
                    onClick={label === "Platform Analytics" ? () => setCurrentView("progress") : undefined}
          ...
          <div className="flex flex-col h-full bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden min-h-[800px]">
            <div className="p-4 border-b border-gray-100 flex items-center bg-gray-50/80">
              <button 
                onClick={() => setCurrentView('dashboard')} 
                className="text-sm font-bold text-gray-600 hover:text-cyan-600 flex items-center px-4 py-2 bg-white border border-gray-200 rounded-lg hover:shadow-sm transition-all"
              >
                ← Back to Dashboard
              </button>
            </div>
            <StudentProgress role="admin" user={{ role: 'admin', fullName: 'Administrator', email: adminEmail }} />
          </div>
        )}
      </main>
    </div>
