...
const STUDENT_INTERESTS = [
  { id: 'computer_science', icon: '💻', label: 'Computer Science',  sub: 'AI, Algorithms, Dev'        },
  { id: 'web_dev',          icon: '🌐', label: 'Web Development',   sub: 'React, Node, CSS'           },
  { id: 'data_science',     icon: '📊', label: 'Data Science',      sub: 'Analytics, Viz, Stats'      },
  { id: 'ai_ml',            icon: '🤖', label: 'AI & ML',           sub: 'Deep Learning, NLP'         },
  { id: 'cybersecurity',    icon: '🔐', label: 'Cybersecurity',     sub: 'Networks, Ethical Hacking'  },
  { id: 'mobile_dev',       icon: '📱', label: 'Mobile Dev',        sub: 'Flutter, React Native'      },
  { id: 'cloud',            icon: '☁️',  label: 'Cloud Computing',   sub: 'AWS, Azure, DevOps'         },
  { id: 'database',         icon: '🗄️',  label: 'Databases',         sub: 'SQL, MongoDB, Redis'        },
  { id: 'software_eng',     icon: '⚙️',  label: 'Software Eng',      sub: 'Patterns, Architecture'    },
  { id: 'ui_ux',            icon: '🎨', label: 'UI/UX Design',      sub: 'Figma, Prototyping'         },
  { id: 'networking',       icon: '🔗', label: 'Networking',        sub: 'Protocols, TCP/IP'          },
  { id: 'blockchain',       icon: '⛓️',  label: 'Blockchain',        sub: 'Web3, Smart Contracts'      },
  { id: 'game_dev',         icon: '🎮', label: 'Game Dev',          sub: 'Unity, Unreal, C++'         },
  { id: 'iot',              icon: '📡', label: 'IoT',               sub: 'Arduino, Raspberry Pi'      },
  { id: 'mathematics',      icon: '📐', label: 'Mathematics',       sub: 'Calculus, Stats, Logic'     },
  { id: 'physics',          icon: '⚛️',  label: 'Physics',           sub: 'Mechanics, Quantum'         },
]

const LECTURER_SUBJECTS = [
  { id: 'teach_cs',       icon: '💻', label: 'Computer Science',      sub: 'Programming, Theory'      },
  { id: 'teach_ai',       icon: '🤖', label: 'AI & Machine Learning', sub: 'Research, Teaching'       },
  { id: 'teach_data',     icon: '📊', label: 'Data Science',          sub: 'Statistics, Analytics'    },
  { id: 'teach_web',      icon: '🌐', label: 'Web Technologies',      sub: 'Full Stack, Frameworks'   },
  { id: 'teach_security', icon: '🔐', label: 'Cybersecurity',         sub: 'Network Security'         },
  { id: 'teach_software', icon: '⚙️',  label: 'Software Engineering',  sub: 'Design Patterns'         },
  { id: 'teach_math',     icon: '📐', label: 'Mathematics',           sub: 'Calculus, Discrete Math'  },
  { id: 'teach_networks', icon: '🔗', label: 'Computer Networks',     sub: 'Protocols, Systems'       },
  { id: 'teach_db',       icon: '🗄️',  label: 'Database Systems',      sub: 'SQL, NoSQL, Design'      },
  { id: 'teach_cloud',    icon: '☁️',  label: 'Cloud & DevOps',        sub: 'AWS, CI/CD, Docker'      },
  { id: 'teach_mobile',   icon: '📱', label: 'Mobile Development',    sub: 'iOS, Android, Cross'      },
  { id: 'teach_research', icon: '🔬', label: 'Research Methods',      sub: 'Academic Writing'         },
]
...
export default function Interests() {
  ...
  const items    = isLecturer ? LECTURER_SUBJECTS : STUDENT_INTERESTS
      ...
      <nav className="flex items-center justify-between px-8 py-4
        ...
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center
            ...
            style={{ color: '#00b8a9', borderColor: '#00b8a9' }}>✦</div>
          <span className="font-bold text-[#1a1a2e] text-sm">Smart Study Circle</span>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="flex-1 flex flex-col items-center px-6 py-10 pb-32">
        ...
        <div className="text-center mb-8 max-w-xl">
          <h1 className="text-4xl font-extrabold text-[#1a1a2e] mb-3 font-head">
            {isLecturer ? 'What do you teach?' : 'What sparks your interest?'}
          </h1>
          <p className="text-sm text-gray-500 leading-relaxed">
            {isLecturer
              ? 'Select your teaching subjects so students can find your study circles.'
              : "We'll use this to suggest the best study circles for you. Choose at least 3 topics to get started."
            }
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-5xl">
          ...
          {filtered.length === 0 && (
            <div className="col-span-4 text-center py-12 text-gray-400 text-sm">
              No topics found for "<span className="text-gray-600">{search}</span>"
            </div>
          )}
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 border-t border-gray-100
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={handleFinish}
            ...
            {loading ? '⏳ Saving...' : <>Finish Onboarding <span>→</span></>}
          </button>
        </div>
      </div>
    </div>
