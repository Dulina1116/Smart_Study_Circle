...
export default function ResourcePreviewPage() {
  ...
  const previewType = useMemo(() => {
    ...
    if (["doc", "ppt", "pptx", "xls", "xlsx", "zip", "rar"].includes(extension))
      return "unsupported";
    if (["document", "presentation", "other"].includes(resource?.type || ""))
      return "unsupported";
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-xs text-slate-600">
                ...
                {resource.fileSize
                  ? `${Math.round((resource.fileSize / 1024) * 100) / 100} KB`
                  : "-"}
              </div>
                  ...
                  <div className="h-[70vh] grid place-items-center p-6 text-center">
                    <div>
                      ...
                      <p className="text-sm text-slate-600 mb-3">
                        External resource link detected.
                      </p>
                      <a
                  ...
                  <div className="h-[70vh] grid place-items-center p-6 text-center">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        For editable docs, upload as .docx for inline preview.
                        Otherwise use Download Resource.
                      </p>
                      <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
                        ...
                        {officeViewerUrl ? (
                          ...
                          >
                            <ExternalLink className="w-3.5 h-3.5 mr-1.5" /> Try
                            Office Viewer
                          </a>
                        ) : null}
                      </div>
